 ...
 */
"use strict";var attempt=_dereq_("attempt-x"),reduce=_dereq_("array-reduce-x"),replaceComments=_dereq_("replace-comments-x"),normalise=_dereq_("normalize-space-x"),trim=_dereq_("trim-x"),fToString=Function.prototype.toString,sMatch=String.prototype.match,sSplit=String.prototype.split,ARROW_ARG=/^([^(]+?)=>/,FN_ARGS=/^[^(]*\( *([^)]*)\)/m,isFunction=_dereq_("is-function-x"),reducer=function _reducer(acc,item){var a=trim(item);return a&&(acc[acc.length]=a),acc};module.exports=function getFunctionArgs(fn){if(!1!==isFunction(fn,!0)){var result=attempt.call(fn,fToString);if(result.threw)return"";var str=normalise(replaceComments(result.value," ")),match=sMatch.call(str,ARROW_ARG)||sMatch.call(str,FN_ARGS);return reduce(match?sSplit.call(match[1],","):[],reducer,[])}}},{"array-reduce-x":3,"attempt-x":5,"is-function-x":11,"normalize-space-x":20,"replace-comments-x":21,"trim-x":34}],2:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isFunction=_dereq_("is-function-x"),safeToString=_dereq_("safe-to-string-x"),isPrimitive=_dereq_("is-primitive");module.exports=function assertIsFunction(callback){if(!1===isFunction(callback)){var msg=isPrimitive(callback)?safeToString(callback):"#<Object>";throw new TypeError(msg+" is not a function")}return callback}},{"is-function-x":11,"is-primitive":14,"safe-to-string-x":23}],5:[function(_dereq_,module,exports){/**
 ...
 * @module is-finite-x
 */
"use strict";var numberIsNaN=_dereq_("is-nan-x");module.exports=function isFinite(number){return"number"==typeof number&&!1===numberIsNaN(number)&&number!==1/0&&number!==-1/0}},{"is-nan-x":12}],11:[function(_dereq_,module,exports){/**
 ...
 * @module is-nan-x
 */
"use strict";module.exports=function isNaN(value){return value!==value}},{}],13:[function(_dereq_,module,exports){/**
 ...
 * @module math-sign-x
 */
"use strict";var toNumber=_dereq_("to-number-x"),numberIsNaN=_dereq_("is-nan-x");module.exports=function sign(x){var n=toNumber(x);return 0===n||numberIsNaN(n)?n:n>0?1:-1}},{"is-nan-x":12,"to-number-x":27}],19:[function(_dereq_,module,exports){"use strict";module.exports=9007199254740991},{}],20:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var trim=_dereq_("trim-x"),reNormalize=new RegExp("["+_dereq_("white-space-x").string+"]+","g");module.exports=function normalizeSpace(string){return trim(string).replace(reNormalize," ")}},{"trim-x":34,"white-space-x":36}],21:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isString=_dereq_("is-string"),STRIP_COMMENTS=/((\/\/.*$)|(\/\*[\s\S]*?\*\/))/gm;module.exports=function replaceComments(string){var replacement=arguments.length>1&&isString(arguments[1])?arguments[1]:"";return isString(string)?string.replace(STRIP_COMMENTS,replacement):""}},{"is-string":15}],22:[function(_dereq_,module,exports){/**
 ...
 * @module to-object-x
 */
"use strict";var requireObjectCoercible=_dereq_("require-object-coercible-x");module.exports=function toObject(value){return Object(requireObjectCoercible(value))}},{"require-object-coercible-x":22}],29:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isNull=_dereq_("lodash.isnull"),isUndefined=_dereq_("validate.io-undefined"),toStr=Object.prototype.toString;module.exports=function toStringTag(value){return isNull(value)?"[object Null]":isUndefined(value)?"[object Undefined]":toStr.call(value)}},{"lodash.isnull":17,"validate.io-undefined":35}],31:[function(_dereq_,module,exports){/**
 ...
 * @module to-string-x
 */
"use strict";var isSymbol=_dereq_("is-symbol");module.exports=function ToString(value){if(isSymbol(value))throw new TypeError("Cannot convert a Symbol value to a string");return String(value)}},{"is-symbol":16}],32:[function(_dereq_,module,exports){/**
