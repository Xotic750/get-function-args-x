...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["getFunctionArgsX"] = factory();
	else
		root["getFunctionArgsX"] = factory();
})((function () {
  'use strict';
...
// CONCATENATED MODULE: ./dist/get-function-args-x.esm.js
...
var get_function_args_x_esm_fToString = simple_methodize_x_esm(attempt_x_esm.toString);
var get_function_args_x_esm_SPACE = ' ';
var sMatch = simple_methodize_x_esm(get_function_args_x_esm_SPACE.match);
var sSplit = simple_methodize_x_esm(get_function_args_x_esm_SPACE.split);
var ARROW_ARG = /^([^(]+?)=>/;
var FN_ARGS = /^[^(]*\( *([^)]*)\)/m;

var get_function_args_x_esm_reducer = function reducer(acc, item) {
  var a = trim_x_esm(item);
...
var attemptee = function attemptee(fn) {
  return get_function_args_x_esm_fToString(fn);
};
/**
...
var get_function_args_x_esm_getFunctionArgs = function getFunctionArgs(fn) {
  var result = attempt_x_esm(attemptee, fn);
  ...
  var str = normalize_space_x_esm(replace_comments_x_esm(result.value, get_function_args_x_esm_SPACE));
  var match = sMatch(str, ARROW_ARG) || sMatch(str, FN_ARGS);
  return array_reduce_x_esm(match ? sSplit(match[1], ',') : [], get_function_args_x_esm_reducer, []);
};

/* harmony default export */ var get_function_args_x_esm = __webpack_exports__["default"] = (get_function_args_x_esm_getFunctionArgs);
...
//# sourceMappingURL=get-function-args-x.js.map