...
var fToString = simple_methodize_x_esm(attempt_x_esm.toString);
...
var get_function_args_x_esm_attemptee = function attemptee(fn) {
  return fToString(fn);
};
/**
...
var get_function_args_x_esm_getFunctionArgs = function getFunctionArgs(fn) {
  var result = attempt_x_esm(get_function_args_x_esm_attemptee, fn);
