...
var get_function_args_x_esm_fToString = attempt_x_esm.toString;
var get_function_args_x_esm_SPACE = ' ';
var sMatch = get_function_args_x_esm_SPACE.match;
var sSplit = get_function_args_x_esm_SPACE.split;
var ARROW_ARG = /^([^(]+?)=>/;
var FN_ARGS = /^[^(]*\( *([^)]*)\)/m;
...
var get_function_args_x_esm_getFunctionArgs = function getFunctionArgs(fn) {
  if (is_function_x_esm(fn, true) === false) {
    /* eslint-disable-next-line no-void */
    return void 0;
  }

  var result = attempt_x_esm.call(fn, get_function_args_x_esm_fToString);
  ...
  return array_reduce_x_esm(match ? sSplit.call(match[1], ',') : [], get_function_args_x_esm_reducer, []);
};
